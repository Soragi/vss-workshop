...
- **LVS (video-summarization) image tags:** x86 / Jetson Thor uses `nvcr.io/nvidia/vss-core/vss-video-summarization:3.2.1-rc1-d16a216` (`LVS_TAG=3.2.1-rc1-d16a216`); SBSA / DGX Spark / Grace uses `nvcr.io/nvidia/vss-core/vss-video-summarization:3.2.1-rc1-d16a216-arm64-sbsa` (`LVS_TAG=3.2.1-rc1-d16a216-arm64-sbsa`).
...
- **RT-VLM AND LVS image tags must match the CPU platform.** x86 and Jetson Thor platforms, including AGX/IGX Thor, use the non-sbsa tags: `RTVI_VLM_IMAGE_TAG=3.2.1-26.07.1` (`nvcr.io/nvidia/vss-core/vss-rt-vlm:3.2.1`) and `LVS_TAG=3.2.1-rc1-d16a216` (`nvcr.io/nvidia/vss-core/vss-video-summarization:3.2.1-rc1-d16a216`). SBSA server-ARM platforms, including DGX Spark and Grace, use the sbsa tags: `RTVI_VLM_IMAGE_TAG=3.2.1-26.07.1-sbsa` (`nvcr.io/nvidia/vss-core/vss-rt-vlm:3.2.1-sbsa`) and `LVS_TAG=3.2.1-rc1-d16a216-arm64-sbsa` (`nvcr.io/nvidia/vss-core/vss-video-summarization:3.2.1-rc1-d16a216-arm64-sbsa`). LLM-side, follow `edge.md`: DGX Spark uses the standalone DGX Spark Nano 9B NIM, while AGX/IGX Thor still uses the Edge 4B fallback.
