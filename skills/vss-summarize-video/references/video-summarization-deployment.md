...
| video summarization image | `${LVS_IMAGE:-nvcr.io/nvidia/vss-core/vss-video-summarization}:${LVS_TAG:-3.2.1-rc1-d16a216}` (use `LVS_TAG=3.2.1-rc1-d16a216-arm64-sbsa` on SBSA / DGX Spark / Grace) |
