...
| video summarization image | `${LVS_IMAGE:-nvcr.io/nvstaging/vss-core/vss-video-summarization}:${LVS_TAG:-3.2.1-rc1-d16a216}` |
...
| `LVS_TAG` | `3.2.1-rc1-d16a216` | video summarization image tag in current develop. |
